...
struct AcronymsController: RouteCollection {
    ...
    func createHandler(_ req: Request, acronymCreateData: AcronymCreateData) throws -> Future<Acronym> {
        let user = try req.requireAuthenticated(User.self)
        let acronym = try Acronym(short: acronymCreateData.short, long: acronymCreateData.long, userID: user.requireID())
